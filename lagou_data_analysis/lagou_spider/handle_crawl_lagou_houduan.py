...
from lagou_data_analysis.lagou_spider.handle_insert_data import lagou_mysql
...
class HandleLaGou(object):
    ...
    def handle_request(self,method,url,data=None,info=None):
        while True:
            #加入阿布云的动态代理
            proxyinfo = "http://%s:%s@%s:%s" % ('H4FJM3WZYGEP79ND', '6D8897ED95103EBC', 'http-dyn.abuyun.com', '9020')
            proxy = {
                "http":proxyinfo,
                "https":proxyinfo
            }
